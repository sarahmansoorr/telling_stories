...
colnames(data_2015) <- c("Operation Name", "Operation Type", "Address",
...
# Cleaning 2016 data
colnames(data_2016) <- c("Operation Name", "Operation Type", "Address",
                         "City", "Postal Code", "Total Floor Area",
                         "Unit", "Avg hrs/wk", "Annual Flow (Mega Liters)",
                         "Electricity Quantity", "Electricity Unit",
                         "Natural Gas Quantity", "Natural Gas Unit", 
...
# Cleaning 2017 data
colnames(data_2017) <- c("Operation Name", "Operation Type", "Address",
                         "City", "Postal Code", "Total Floor Area",
                         "Unit", "Avg hrs/wk", "Annual Flow (Mega Liters)",
                         "Electricity Quantity", "Electricity Unit",
                         "Natural Gas Quantity", "Natural Gas Unit", 
...
# Cleaning 2018 data
colnames(data_2018) <- c("Operation Name", "Operation Type", "Address",
                         "City", "Postal Code", "Total Floor Area",
                         "Unit", "Avg hrs/wk", "Annual Flow (Mega Liters)",
                         "Electricity Quantity", "Electricity Unit",
                         "Natural Gas Quantity", "Natural Gas Unit", 
