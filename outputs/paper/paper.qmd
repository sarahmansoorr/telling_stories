...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.cap="GHG Emissions for 2015 by Operation Type", fig.width=7, fig.height=3.2}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.cap="GHG Emissions for 2016 by Operation Type", fig.width=7, fig.height=3.2}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.cap="GHG Emissions for 2017 by Operation Type", fig.width=7, fig.height=3.2}
...
As seen in Figures 1 to 4, there are drastic changes in GHG emissions by operation type and city from 2015 to 2018. From 2015 to 2016, GHG emissions were the most in Toronto for the sewage treatment operation, and the second highest was Toronto for the water treatment operation.  
